                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <header class="table-header">
                                <div class="row">
                                    <div class="col">
                                        <h3 class="table-header-title">Animals</h3>
                                    </div>
                                    <div class="col-auto">
                                            ...
                                            <c:forEach var="animal" items="${animals}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-row">
                                                            <div class="col-auto">
                                                                <a class="btn btn-success" href="<c:url value="/animals/${animal.id}/edit"/>">
                                                                    <i class="fa fa-pen"></i>
                                                                </a>
                                                            </div>
                                                            <div class="col-auto">
                                                                <a class="btn btn-outline-danger" href="<c:url value="/animals/${animal.id}/delete"/>">
