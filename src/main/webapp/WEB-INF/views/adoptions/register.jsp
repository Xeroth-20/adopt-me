...
<html lang="en">
    <head>
        ...
        <title>Register Adoption | Adopt Me</title>
    </head>
    <body>
        <div class="root">
                        ...
                        <div class="col-9">
                            <div class="row">
                                <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
                                    <h3>Register adoption</h3>
                                    <form:form modelAttribute="adoption" method="post">
                                        <div class="form-group">
                                            <form:label path="owner.id">
                                                Owner
                                            </form:label>
                                            <form:select path="owner.id" cssClass="form-control">
                                                <form:option value="" label="--Select an owner--"/>
                                                <form:options items="${owners}" itemValue="id" itemLabel="fullname"/>
                                            </form:select>
                                        </div>
                                        <div class="form-group">
