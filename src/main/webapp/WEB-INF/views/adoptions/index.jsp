                                        ...
                                        <c:forEach var="adoption" items="${adoptions}">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-row">
                                                        <div class="col-auto">
                                                            <a class="btn btn-success" href="<c:url value="/adoptions/${adoption.id}/edit"/>">Edit</a>
                                                        </div>
                                                        <div class="col-auto">
                                                            <a class="btn btn-outline-danger" href="<c:url value="/adoptions/${adoption.id}/delete"/>">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
