...
<html lang="en">
    <head>
        ...
        <title>Delete Adoption | Adopt Me</title>
    </head>
    <body>
        <div class="root">
                ...
                <main class="container py-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="<c:url value="/adoptions"/>">Adoptions</a>
                            </li>
                        ...
                        <div class="col-9">
                            <div class="row">
                                <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
                                    <h3>Delete adoption</h3>
                                    <form:form modelAttribute="adoption" method="post">
                                        <div class="form-group d-none">
                                            <form:label path="id">ID</form:label>
                                            <form:input path="id" readonly="true"/>
                                        </div>
                                        <div class="form-group">
                                            <form:label path="owner.fullname">
                                                Owner
                                            </form:label>
                                            <form:input path="owner.fullname" cssClass="form-control" disabled="true"/>
                                        </div>
                                        <div class="form-group">
                                            <form:label path="pet.name">
                                                Pet
                                            </form:label>
                                            <form:input path="pet.name" cssClass="form-control" disabled="true"/>
                                        </div>
                                        <div class="form-group">
                                            <p class="text-danger">Are you sure to delete this adoption?</p>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col">
                                                ...
                                                <div class="col-auto">
                                                    <a class="btn btn-block btn-outline-info" href="<c:url value="/adoptions"/>">
                                                        Go back
                                                    </a>
                                                </div>
                                            </div>
