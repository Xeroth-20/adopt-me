...
<html lang="en">
    <head>
        ...
        <title>Medical Records | Adopt me</title>
    </head>
    <body>
        <div class="root">
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <header class="table-header">
                                <div class="row">
                                    <div class="col">
                                        <h3 class="table-header-title">Medical Records</h3>
                                    </div>
                                    <div class="col-auto">
                                        <a class="btn btn-primary" href="<c:url value="/medical-records/register"/>">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <c:choose>
                                        <c:when test="${medicalRecords.size() > 0}">
                                            <c:forEach var="medicalRecord" items="${medicalRecords}">
                                                <tr>
                                                    <td>${medicalRecord.id}</td>
                                                    <td>${medicalRecord.pet.name}</td>
                                                    <td>${medicalRecord.creationDate}</td>
                                                    <td>
                                                        <div class="form-row">
                                                            <div class="col-auto">
                                                                <a class="btn btn-primary" href="<c:url value="/medical-records/${medicalRecord.id}/dosages"/>">
                                                                    <i class="fa fa-eye"></i>
                                                                </a>
                                                            </div>
                                                            <div class="col-auto">
                                                            ...
                                                            <div class="col-auto">
                                                                <a class="btn btn-success" href="<c:url value="/medical-records/${medicalRecord.id}/edit"/>">
                                                                    <i class="fa fa-pen"></i>
                                                                </a>
                                                            </div>
                                                            <div class="col-auto">
                                                                <a class="btn btn-outline-danger" href="<c:url value="/medical-records/${medicalRecord.id}/delete"/>">
