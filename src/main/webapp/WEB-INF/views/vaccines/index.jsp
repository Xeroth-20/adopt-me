                                        ...
                                        <c:forEach var="vaccine" items="${vaccines}">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-row">
                                                        <div class="col-auto">
                                                            <a class="btn btn-success" href="<c:url value="/vaccines/${vaccine.id}/edit"/>">Edit</a>
                                                        </div>
                                                        <div class="col-auto">
                                                            <a class="btn btn-outline-danger" href="<c:url value="/vaccines/${vaccine.id}/delete"/>">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
