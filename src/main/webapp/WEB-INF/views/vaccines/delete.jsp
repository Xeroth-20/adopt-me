...
<html lang="en">
    <head>
        ...
        <title>Edit Vaccine | Adopt Me</title>
    </head>
    <body>
        <div class="root">
                ...
                <main class="container py-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="<c:url value="/vaccines"/>">Vaccines</a>
                            </li>
                        ...
                        <div class="col-9">
                            <div class="row">
                                <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
                                    <h3>Delete vaccine</h3>
                                    <form:form modelAttribute="vaccine" method="post">
                                        ...
                                        <div class="form-group">
                                            <p class="text-danger">Are you sure to delete this vaccine?</p>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col">
                                                ...
                                                <div class="col-auto">
                                                    <a class="btn btn-block btn-outline-info" href="<c:url value="/vaccines"/>">
                                                        Go back
                                                    </a>
                                                </div>
                                            </div>
