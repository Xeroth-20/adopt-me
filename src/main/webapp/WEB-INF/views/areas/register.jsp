...
<html lang="en">
    <head>
        ...
        <title>Register Area | Adopt Me</title>
    </head>
    <body>
        <div class="root">
                        ...
                        <div class="row">
                            <div class="col-4">
                                ...
                                <form:form modelAttribute="area" method="post">
                                    ...
                                    <div class="form-group">
                                        <form:label path="squareMeters">
                                            Square meters
                                        </form:label>
                                        <form:input path="squareMeters" cssClass="form-control"/>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col">
                                            ...
                                            <div class="col-auto">
                                                <a class="btn btn-block btn-outline-info" href="<c:url value="/areas"/>">
                                                    Go back
                                                </a>
                                            </div>
                                        </div>
