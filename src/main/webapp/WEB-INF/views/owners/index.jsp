                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <header class="table-header">
                                <div class="row">
                                    <div class="col">
                                        <h3 class="table-header-title">Owners</h3>
                                    </div>
                                    <div class="col-auto">
                                        <a class="btn btn-primary" href="<c:url value="/owners/register"/>">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col-auto">
                                                                <a class="btn btn-outline-danger" href="<c:url value="/owners/${owner.id}/delete"/>">
